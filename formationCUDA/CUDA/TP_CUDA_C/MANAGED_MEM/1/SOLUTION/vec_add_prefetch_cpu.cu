...
int main(void){
	...
	//prefetching data here will amke the check routine run faster.
	//Elapsed time is not comparable to the other runtimes.
	cudaMemPrefetchAsync(res, n * sizeof(float), cudaCpuDeviceId);
